...
//UPDATES: 14.04.2012 - Bugfix : Search for "export" and "logout" globaly
//////////////////////////////
    ...
    foreach( $this->keytwo as $tkeys ) {
      ...
      if( $key != false ) { 
        ...
        if( in_array( $tkeys, $this->keyver ) ) { 
          if( $this->verify( $tkeys, mres( $uarr[$key+1] ) )) {
            unset( $uarr[$key+1] ); //20120414 fix : don't use this elsewhere
          }
        //other keys
        } else {
