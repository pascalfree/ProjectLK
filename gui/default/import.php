...
$toolbar = link_back();
if(file_exists($importfile)) { $toolbar.=' <a href="javascript: void(0)" onclick="javascript: req(\'delete_import\',\'\',\'javascript:location.href=path();\')">'.$la['otherfile'].'</a>'; }
load_head($toolbar);
$errors='';
...
<?php
  ...
  <div class="middlebox">
    ...
    <form enctype="multipart/form-data" action="" method="POST">
      <input type="file" name="newimport"/>
